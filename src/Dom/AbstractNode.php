<?php
namespace packages\PHPHtmlParser\Dom;

use packages\PHPHtmlParser\Exceptions\CircularException;
use packages\PHPHtmlParser\Exceptions\ParentNotFoundException;
use packages\PHPHtmlParser\Exceptions\ChildNotFoundException;
use packages\PHPHtmlParser\Selector\Selector;
use packages\PHPHtmlParser\Selector\Parser as SelectorParser;
use packages\stringEncode\Encode;
use packages\PHPHtmlParser\Finder;
 ...
 * @property int prev
 * @property int next
 * @property packages\PHPHtmlParser\Dom\Tag tag
...
abstract class AbstractNode
{
     ...
     *
     * @var packages\PHPHtmlParser\Dom\Tag
     */
    protected $tag;
