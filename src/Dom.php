...
use packages\PHPHtmlParser\Dom\HtmlNode;
use packages\PHPHtmlParser\Dom\TextNode;
use packages\PHPHtmlParser\Exceptions\NotLoadedException;
use packages\PHPHtmlParser\Exceptions\StrictException;
...
class Dom
{
     ...
     *
     * @return packages\PHPHtmlParser\Dom\AbstractNode
     */
    public function firstChild(): packages\PHPHtmlParser\Dom\AbstractNode
    {
        $this->isLoaded();
     ...
     * @return packages\PHPHtmlParser\Dom\AbstractNode
     */
    public function lastChild(): packages\PHPHtmlParser\Dom\AbstractNode
    {
        $this->isLoaded();
